...
def add_people():
    ...
    while addition:
        add_more = input("Would you like to add a new person? Please 'Yes' or 'No' \n")
        if add_more == "Yes":
            addition = True
        elif add_more == "No":
            addition = False
...
# Handle arguments
    ...
    elif selection == DRINKS_FILE_DATA:
        update_drinks_with_file()
